...
public class BookmarkAdd  extends AbstractSample {
	...
	public static void main(String[] args) throws Exception {
		...
		wordMLPackage.getMainDocumentPart().addParagraphOfText("x");  // 0
		wordMLPackage.getMainDocumentPart().addParagraphOfText("x");  // 1
		wordMLPackage.getMainDocumentPart().addParagraphOfText("hello world"); // 2
