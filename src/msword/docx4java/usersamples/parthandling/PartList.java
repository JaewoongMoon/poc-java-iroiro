package msword.docx4java.usersamples.parthandling;
...
public class PartList extends AbstractSample {
	
	private static Logger log = Logger.getLogger(PartList.class);						
